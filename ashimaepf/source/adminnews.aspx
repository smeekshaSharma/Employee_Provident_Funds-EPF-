...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select count(*)from news where nsub='" & t2.Text & "'")
        comm.Connection = conn
        count = comm.ExecuteScalar
        If count > 0 Then
            MsgBox("This About Subject Already Exist")
            conn.Close()
            t2.Text = ""
        Else
            sql = "insert into news values('" & t1.Text & "','" & t2.Text & "','" & t3.Text & "','" & FileUpload1.FileName & "')"
            adp.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
            adp.InsertCommand.ExecuteScalar()
            MsgBox("News Detail Submitted Successfully")
            t1.Text = ""
            t2.Text = ""
            t3.Text = ""
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        count = comm.ExecuteScalar
        If count > 0 Then
            comm = New Data.SqlClient.SqlCommand("select cdate from news where nsub='" & t2.Text & "'")
            comm.Connection = conn
            t2.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select ndesc from news where nsub='" & t2.Text & "'")
            comm.Connection = conn
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("delete from news where nsub='" & t2.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("News Detail Deleted Successfuylly")
        conn.Close()
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("update news set ndesc ='" & t3.Text & "',pdf='" & FileUpload1.FileName & "', cdate='" & t1.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
  ...
  <div id="apDiv5">
    ...
    <div id="apDiv7">
      <div id="apDiv8" style="border:1px solid #27408B;border-radius:10px">
        <table width="100%" border="0">
          <tr>
            <td colspan="3" bgcolor="#27408B"><span class="style5"><strong>EPF NEWS DETAIL</strong></span></td>
          </tr>
          <tr>
            <td colspan="3">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><span class="style29"> News Subject</span></td>
            <td>
                <asp:TextBox ID="t2" runat="server"></asp:TextBox>              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><span class="style29">News Description</span></td>
            <td>
