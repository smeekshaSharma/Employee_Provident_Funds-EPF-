...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select count(*)from pm where sname='" & t2.Text & "'")
        comm.Connection = conn
        count = comm.ExecuteScalar
        If count > 0 Then
            MsgBox("this pm subject already exist")
            conn.Close()
            t2.Text = ""
        Else
            sql = "insert into pm values('" & t1.Text & "','" & t2.Text & "','" & t3.Text & "','" & t4.Text & "','" & t5.Text & "','" & t6.Text & "','" & t7.Text & "','" & FileUpload1.FileName & "')"
            adp.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
            adp.InsertCommand.ExecuteScalar()
            MsgBox("pm detail submitted successfully")
            t1.Text = ""
            t2.Text = ""
            t3.Text = ""
            t4.Text = ""
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        count = comm.ExecuteScalar
        If count > 0 Then
            comm = New Data.SqlClient.SqlCommand("select cdate from pm where sname='" & t2.Text & "'")
            comm.Connection = conn
            t1.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select ecri from pm where sname='" & t2.Text & "'")
            comm.Connection = conn
            t3.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select snb from pm where sname='" & t2.Text & "'")
            comm.Connection = conn
            t4.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select hssp from pm where sname='" & t2.Text & "'")
            comm.Connection = conn
            t5.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select fea from pm where sname='" & t2.Text & "'")
            comm.Connection = conn
            t6.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select pp from pm where sname='" & t2.Text & "'")
            comm.Connection = conn
            t7.Text = comm.ExecuteScalar
        Else
            MsgBox("this news not exist")
            conn.Close()
            t1.Text = ""
            t2.Text = ""
            t3.Text = ""
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("delete from pm where sname='" & t2.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("pm detail deleted successfuylly")
        conn.Close()
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("update pm set pp =  '" & t7.Text & "',fea= '" & t6.Text & "', hssp='" & t5.Text & "',snb='" & t4.Text & "',ecri='" & t3.Text & "',pdf='" & FileUpload1.FileName & "', cdate='" & t1.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("news detail updated successfully")
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
        t4.Text = ""
  ...
  <div id="apDiv5">
    ...
    <div id="apDiv7">
      <div id="apDiv8" style="border:1px solid #27408B;border-radius:10px">
        <table width="100%" border="0">
          <tr>
            <td colspan="3" bgcolor="#27408B"><span class="style5"><strong>EPF PM-SYM Schemes DETAIL</strong></span></td>
          </tr>
          <tr>
            <td colspan="3">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><span class="style30">Scheme Name</span></td>
            <td>
                <asp:TextBox ID="t2" runat="server"></asp:TextBox>              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><span class="style30">Eligibility Criteria</span></td>
            <td>
                <asp:TextBox ID="t3" runat="server"></asp:TextBox>              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><span class="style30">Should not be</span></td>
            <td>
                <asp:TextBox ID="t4" runat="server"></asp:TextBox>              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><span class="style30">He/She Should Process</span></td>
            <td>
                <asp:TextBox ID="t5" runat="server"></asp:TextBox>              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><span class="style30">Features</span></td>
            <td>
                <asp:TextBox ID="t6" runat="server"></asp:TextBox>              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><span class="style30">Pension Payout</span></td>
            <td>
          ...
          <tr>
            <td><span class="style30">PDF/ Document</span></td>
            <td>
