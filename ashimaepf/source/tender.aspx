...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','903','height','301','src','../animation/Movie2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../animation/Movie2' ); //end AC code
  ...
  <div id="apDiv14">
    <div id="apDiv15">
      <table width="100%" border="0">
        <tr>
          <th bgcolor="#058383" scope="col"><strong>Employee Provident Fund Tender Detail</strong></th>
        </tr>
        <tr>
          <td><hr /></td>
        </tr>
        ...
        <tr>
          <td>
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                  DataSourceID="SqlDataSource2" AllowPaging="True" Width="100%">
                  <Columns>
                      <asp:BoundField DataField="cdate" HeaderText="Current Date" 
                          SortExpression="cdate" />
                      <asp:BoundField DataField="ty" HeaderText="Type" SortExpression="ty" />
                      <asp:BoundField DataField="ta" HeaderText="Tender/Auction No" 
                          SortExpression="ta" />
                      <asp:BoundField DataField="ts" HeaderText="Tender Subject" 
                          SortExpression="ts" />
                      <asp:BoundField DataField="ld" HeaderText="Last Date" SortExpression="ld" />
                      <asp:BoundField DataField="pp" HeaderText="PDF/Document" SortExpression="pp" />
                  </Columns>
              </asp:GridView>
              <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                  ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                  SelectCommand="SELECT [cdate], [ty], [ta], [ts], [ld], [pp] FROM [tender]">
              </asp:SqlDataSource>
            </td>
        </tr>
      </table>
