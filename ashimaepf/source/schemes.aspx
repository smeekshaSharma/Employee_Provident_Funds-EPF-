...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','903','height','301','src','../animation/Movie2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../animation/Movie2' ); //end AC code
  ...
  <div id="apDiv14">
    <div id="apDiv15">
      <table width="100%" border="0">
        <tr>
          <th bgcolor="#058383" scope="col"><strong>Employee Provident Fund Schemes Detail</strong></th>
        </tr>
        <tr>
          <td><hr /></td>
        </tr>
          ...
          <td>
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                  ...
                  <Columns>
                      ...
                      <asp:BoundField DataField="ecri" HeaderText="ecri" SortExpression="ecri" />
                      <asp:BoundField DataField="snb" HeaderText="snb" SortExpression="snb" />
                      <asp:BoundField DataField="hssp" HeaderText="hssp" SortExpression="hssp" />
                      <asp:BoundField DataField="fea" HeaderText="fea" SortExpression="fea" />
                      <asp:BoundField DataField="pp" HeaderText="pp" SortExpression="pp" />
                      <asp:BoundField DataField="pdf" HeaderText="pdf" SortExpression="pdf" />
                  </Columns>
              </asp:GridView>
              <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                  ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                  SelectCommand="SELECT [cdate], [sname], [ecri], [snb], [hssp], [fea], [pp], [pdf] FROM [pm]">
              </asp:SqlDataSource>
            </td>
        </tr>
      </table>
