...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
            ...
            comm = New Data.SqlClient.SqlCommand("select ecode from oempconfirm where eemail='" & Label1.Text & "'")
            comm.Connection = conn
            ...
            pf = (Val(t5.Text) * pf) / 100
            MsgBox(pf)
            t3.Text = pf * months
        End If
        conn.Close()
        t4.Text = Format(Now, "dd/MM/yyyy")
        t1.Enabled = False
        t2.Enabled = False
        t3.Enabled = False
        t4.Enabled = False
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select oemail from oempconfirm where eemail='" & Label1.Text & "'")
        comm.Connection = conn
        oemail = comm.ExecuteScalar
        comm = New Data.SqlClient.SqlCommand("select orgname from oempconfirm where eemail='" & Label1.Text & "'")
        comm.Connection = conn
        oname = comm.ExecuteScalar
        sql = "insert into withdraw values('" & t1.Text & "','" & t2.Text & "','" & t4.Text & "','" & t5.Text & "','" & t3.Text & "','" & oname & "','" & oemail & "')"
        adp.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
        adp.InsertCommand.ExecuteScalar()
        MsgBox("Withdawr Request submitted successfully")
        conn.Close()
  ...
  <div id="apDiv5">
    <div id="apDiv10">
      <table width="100%" border="0">
        ...
        <tr>
          <th colspan="4" bgcolor="#058383" scope="row"><div align="left" class="style39">PF With Draw Request</div></th>
          </tr>
        <tr>
