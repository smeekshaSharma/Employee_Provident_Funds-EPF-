...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','903','height','301','src','../animation/Movie2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../animation/Movie2' ); //end AC code
  ...
  <div id="apDiv14">
    <div id="apDiv15">
      <table width="100%" border="0">
        <tr>
          <th colspan="2" bgcolor="#058383" scope="col"><span class="style5"><strong>Contact Detail</strong></span></th>
        </tr>
        <tr>
          <td colspan="2"><hr /></td>
        </tr>
        ...
        <tr>
          <td colspan="2">
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                  ...
                  <Columns>
                      <asp:BoundField DataField="office" HeaderText="Office Name" 
                      ...
                      <asp:BoundField DataField="cn" HeaderText="Contact No" SortExpression="cn" />
                      <asp:BoundField DataField="fn" HeaderText="Fax No" SortExpression="fn" />
                  </Columns>
              </asp:GridView>
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                  SelectCommand="SELECT [office], [ad], [pc], [em], [cn], [fn] FROM [contact] WHERE ([ci] = @ci)">
                  <SelectParameters>
