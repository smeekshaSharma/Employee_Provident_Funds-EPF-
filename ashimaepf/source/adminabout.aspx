...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select count(*)from about where asub='" & t2.Text & "'")
        ...
        If count > 0 Then
            ...
            t2.Text = ""
        Else
            sql = "insert into about values('" & t1.Text & "','" & t2.Text & "','" & t3.Text & "')"
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        count = comm.ExecuteScalar
        If count > 0 Then
            comm = New Data.SqlClient.SqlCommand("select cdate from about where asub='" & t2.Text & "'")
            comm.Connection = conn
            t1.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select adesc  from about where asub='" & t2.Text & "'")
            comm.Connection = conn
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("delete from about where asub='" & t2.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("About Detail Deleted Successfuylly")
        conn.Close()
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("update about set adesc ='" & t3.Text & "',cdate='" & t1.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("About Detail Updated Successfully")
        t1.Text = ""
        t2.Text = ""
        t3.Text = ""
  ...
  <div id="apDiv5">
    ...
    <div id="apDiv7">
      <div id="apDiv8" style="border:1px solid #27408B;border-radius:10px">
        <table width="100%" border="0">
          <tr>
            <td colspan="3" bgcolor="#27408B"><span class="style5"><strong>EPF About Us Detail</strong></span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="style34"><span class="style33">About Subject</span></td>
            <td class="style34">
                <asp:TextBox ID="t2" runat="server"></asp:TextBox>              </td>
            <td class="style34"></td>
          </tr>
          <tr>
            <td><span class="style33">About Description</span></td>
            <td>
