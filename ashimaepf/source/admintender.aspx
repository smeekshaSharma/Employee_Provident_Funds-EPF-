...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select count(*)from tender where ta ='" & t2.Text & "'")
        comm.Connection = conn
        count = comm.ExecuteScalar
        If count > 0 Then
            MsgBox("This Tender Subject Already Exist")
            conn.Close()
            t2.Text = ""
        Else
            sql = "insert into tender values('" & t1.Text & "','" & d1.Text & "','" & t2.Text & "','" & t3.Text & "','" & t4.Text & "','" & f1.FileName & "')"
            adp.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
            adp.InsertCommand.ExecuteScalar()
            MsgBox("Tender Detail Submitted Successfully")
            t1.Text = ""
            d1.Text = ""
            t3.Text = ""
            t4.Text = ""
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        count = comm.ExecuteScalar
        If count > 0 Then
            comm = New Data.SqlClient.SqlCommand("select cdate from tender where ta='" & t2.Text & "'")
            comm.Connection = conn
            t1.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select ty from tender where ta='" & t2.Text & "'")
            comm.Connection = conn
            d1.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select ts from tender where ta='" & t2.Text & "'")
            comm.Connection = conn
            t3.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select ld from tender where ta='" & t2.Text & "'")
            comm.Connection = conn
            t4.Text = comm.ExecuteScalar
        Else
            MsgBox("This Tender Not Exist")
            conn.Close()
            t1.Text = ""
            d1.Text = ""
            t3.Text = ""
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("delete from tender where ta='" & t2.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("Tender Detail Deleted Successfuylly")
        conn.Close()
        t1.Text = ""
        d1.Text = ""
        t3.Text = ""
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("update tender set cdate ='" & t1.Text & "',ty='" & d1.Text & "',ts='" & t3.Text & "',ld='" & t4.Text & "',pp='" & f1.FileName & "',ta='" & t2.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("Tender Detail Updated Successfully")
        t1.Text = ""
        d1.Text = ""
        t3.Text = ""
        t4.Text = ""
  ...
  <div id="apDiv5">
    ...
    <div id="apDiv7">
      <div id="apDiv8" style="border:1px solid #27408B;border-radius:10px">
        <table width="100%" border="0">
          <tr>
            <td colspan="3" bgcolor="#27408B"><span class="style5"><strong>EPF Tender Detail</strong></span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><span class="style33">Type</span></td>
            <td>
                <asp:DropDownList ID="d1" runat="server">
                    <asp:ListItem>Select Any One</asp:ListItem>
                    <asp:ListItem>Tenders</asp:ListItem>
                    <asp:ListItem>Auctions</asp:ListItem>
                </asp:DropDownList>
              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><span class="style33">Tender/Auction No</span></td>
            <td>
          ...
          <tr>
            <td><span class="style33">Tender Subject</span></td>
            <td>
          ...
          <tr>
            <td><span class="style33">Last Date</span></td>
            <td>
          ...
          <tr>
            <td><span class="style33">PDF/Photo</span></td>
            <td>
