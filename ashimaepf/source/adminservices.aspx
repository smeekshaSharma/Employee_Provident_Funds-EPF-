...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select count(*)from service where ss='" & t2.Text & "'")
        comm.Connection = conn
        count = comm.ExecuteScalar
        If count > 0 Then
            MsgBox("this service subject already exist")
            conn.Close()
            t2.Text = ""
        Else
            sql = "insert into service values('" & t1.Text & "','" & t2.Text & "','" & t3.Text & "','" & f1.FileName & "')"
            adp.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
            adp.InsertCommand.ExecuteScalar()
            MsgBox("about detail submitted successfully")
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        count = comm.ExecuteScalar
        If count > 0 Then
            comm = New Data.SqlClient.SqlCommand("select sd from service where ss='" & t2.Text & "'")
            comm.Connection = conn
            t3.Text = comm.ExecuteScalar
        Else
            MsgBox("this service not exist")
            conn.Close()
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("delete from service where ss='" & t2.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("service detail deleted successfuylly")
        conn.Close()
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("update service set sd ='" & t3.Text & "',cdate='" & t1.Text & "'where ss='" & t2.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("service detail updated successfully")
  ...
  <div id="apDiv4">
    <table width="100%" border="0">
      <tr>
        ...
        <td width="10%" bgcolor="#27408B"><div align="center" class="style5"></div></td>
  ...
  <div id="apDiv5">
    ...
    <div id="apDiv7">
      <div id="apDiv8" style="border:1px solid #27408B;border-radius:10px">
        <table width="100%" border="0">
          <tr>
            <td colspan="3" bgcolor="#27408B"><span class="style5"><strong>EPF Services Detail</strong></span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><span class="style37">Service Subject</span></td>
            <td>
          ...
          <tr>
            <td><span class="style37">Services Description</span></td>
            <td>
          ...
          <tr>
            <td><span class="style37">PDF/ Document</span></td>
            <td>
