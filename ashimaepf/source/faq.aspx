...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','903','height','301','src','../animation/Movie2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../animation/Movie2' ); //end AC code
  ...
  <div id="apDiv14">
    <div id="apDiv15">
      <table width="100%" border="0">
        <tr>
          <th colspan="2" bgcolor="#058383" scope="col"><strong>Employee Provident Fund Frequently Asked Question Detail</strong></th>
        </tr>
        <tr>
          <td colspan="2"><hr /></td>
        </tr>
        ...
        <tr>
          <td colspan="2">
              ...
              <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
                  ...
                  Width="100%">
                  <Fields>
                      <asp:BoundField DataField="que" HeaderText="Question" SortExpression="que" />
                      <asp:BoundField DataField="ans" HeaderText="Answer" SortExpression="ans" />
                  </Fields>
              </asp:DetailsView>
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                  SelectCommand="SELECT [que], [ans] FROM [faq] WHERE ([faq] = @faq)">
                  <SelectParameters>
                      <asp:ControlParameter ControlID="d1" Name="faq" PropertyName="SelectedValue" 
                          Type="String" />
                  </SelectParameters>
