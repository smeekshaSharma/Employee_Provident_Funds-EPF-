...
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select count(*)from faq where faq='" & d1.Text & "'and que='" & T2.Text & "'")
        comm.Connection = conn
        count = comm.ExecuteScalar
        If count > 0 Then
            MsgBox("This FAQ subject Already Exist")
            conn.Close()
            
        Else
            sql = "insert into faq values('" & t1.Text & "','" & d1.Text & "','" & T2.Text & "','" & t3.Text & "')"
            adp.InsertCommand = New Data.SqlClient.SqlCommand(sql, conn)
            adp.InsertCommand.ExecuteScalar()
            MsgBox("FAQ Detail Submitted Successfully")
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("select count(*)from faq where faq='" & d1.Text & "'")
        comm.Connection = conn
        count = comm.ExecuteScalar
        If count > 0 Then
            comm = New Data.SqlClient.SqlCommand("select cdate from faq where faq='" & d1.Text & "'")
            comm.Connection = conn
            t1.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select que  from faq where faq='" & d1.Text & "'")
            comm.Connection = conn
            T2.Text = comm.ExecuteScalar
            comm = New Data.SqlClient.SqlCommand("select ans  from faq where faq='" & d1.Text & "'")
            comm.Connection = conn
            t3.Text = comm.ExecuteScalar
        Else
            MsgBox("This FAQ Not Exist")
            conn.Close()
            t1.Text = ""
            d1.Text = ""
            T2.Text = ""
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("Delete from faq where faq='" & d1.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
        MsgBox("FAQ Detail Deleted Successfuylly")
        conn.Close()
        t1.Text = ""
        d1.Text = ""
        t3.Text = ""
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        conn = New Data.SqlClient.SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\EPFdatabase.mdf;Integrated Security=True;User Instance=True")
        conn.Open()
        comm = New Data.SqlClient.SqlCommand("update faq set cdate ='" & t1.Text & "',faq='" & d1.Text & "',que='" & T2.Text & "',ans='" & t3.Text & "'")
        comm.Connection = conn
        comm.ExecuteScalar()
  ...
  <div id="apDiv4">
    <table width="100%" border="0">
      <tr>
        ...
        <td width="9%" bgcolor="#27408B"><div align="center" class="style5">
            <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
            </div></td>
        <td width="10%" bgcolor="#27408B"><div align="center" class="style5">
            <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
            </div></td>
        <td width="11%" bgcolor="#27408B"><div align="center" class="style5">
            <asp:LinkButton ID="LinkButton1" runat="server" BackColor="Yellow" 
                BorderColor="Yellow" onclick="LinkButton1_Click">Logout</asp:LinkButton>
            </div></td>
  ...
  <div id="apDiv5">
    ...
    <div id="apDiv7">
      <div id="apDiv8" style="border:1px solid #27408B;border-radius:10px">
        <table width="100%" border="0">
          <tr>
            <td colspan="3" bgcolor="#27408B"><span class="style5"><strong>EPF FAQ Detail</strong></span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><span class="style33">FAQ Type</span></td>
            <td>
          ...
          <tr>
            <td><span class="style33">Question</span></td>
            <td>
          ...
          <tr>
            <td><span class="style33">Answer</span></td>
            <td>
